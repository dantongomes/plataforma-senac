...
//------------------------------------------------------------------------------------------------------------------------
$sql = "INSERT INTO projetos (original_title, overview, release_date, linkgithub, poster_path)"
  . " VALUES(:original_title,  :overview, :release_date, :linkgithub, :poster_path)";
