...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <img src="./poster/senacFundo.png" class="img-fluid"> <!-- Adiciona a classe img-fluid para tornar a imagem responsiva -->
    <div class="container">
        ...
        <p>Seja você um iniciante entusiasmado ou um programador experiente em busca de novidades, o [Nome do Site] é o seu destino para descobrir e compartilhar códigos em diversas linguagens. Junte-se a uma comunidade vibrante, onde você pode</p>
    ...
    <div class="footer">
    <p style="color: white;">&copy; 2024 Sistema de Projetos.</p>
        <p>
